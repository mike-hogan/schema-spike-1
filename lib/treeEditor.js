...
CreateArrayNodeAccessor.prototype.createNode = function(document, newNode) {
    ...
    if(this.nextPathElements.length === 0) {
        ...
        const nodeAccessor = _createNodeAccessor(nextNodeName, nextSchemaNode, _.rest(this.nextPathElements),this.entireSchema);
        nodeAccessor.createNode(arrayItem, newNode);
    }
};
